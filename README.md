A movie search app using the Open Movie Database (OMDb) API. The app uses JavaScript, jQuery, and AJAX including loading JSON data from a server using a GET HTTP request.
